...
<div class="d-flex flex-column flex-shrink-0 justify-content-between" style="width: { sidebarWidth }px;" id="sidebar">
    ...
    <ul class="nav nav-pills flex-column p-4">
        {#if !rotated}
            <a href="/dashboard"><img src="{ RLogo }" alt="Logo" class="img-responsive pt-2 ms-2" style="width:fit-content; margin-bottom: 3rem"></a>
        {:else}
            <a href="/dashboard"><img src="{ logoSmall }" alt="Logo" class="img-responsive pt-2 ms-2" style="width:fit-content; margin-bottom: 3rem"></a>
        {/if}
