<!-- src/lib/EditCompanyModal.svelte -->
<script>
    export let company;

    import { onMount } from 'svelte';
    import { updateCompany } from '../apis/adminApis';
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="editCompanyModalLabel">Şirket Bilgisi Düzenle</h1>
            ...
            <div class="modal-body">
              ...
              <div class="input-group mb-3" id="company-name-group">
                ...
                <input type="text" id="company-name" class="form-control ps-0" placeholder="Firma / Kurum Adı" bind:value={editCompany.name}>
              </div>
              ...
              <div class="input-group mb-3" id="company-address-group">
                ...
                <input type="text" id="company-address" class="form-control ps-0" placeholder="Firma / Kurum Adresi" bind:value={editCompany.address}>
              </div>
            ...
            <button id="save-button" type="submit" class="btn btn-primary border-0 px-3" data-bs-dismiss="modal" on:click={editCompanyC}>
                <span class="d-flex align-items-center">
                    Kaydet
